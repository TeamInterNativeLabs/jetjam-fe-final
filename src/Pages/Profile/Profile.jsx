                            ...
                            <div className="profile-card mt-4">
                                ...
                                <div className="row">
                                    <div className="col-sm-4 my-3">
                                        <label htmlFor="" className="semi-bold">First Name</label>
                                        <p className="l-grey-text mb-0">{user?.first_name}</p>
                                    </div>
                                    <div className="col-sm-4 my-3">
                                        <label htmlFor="" className="semi-bold">Last Name</label>
                                        <p className="l-grey-text mb-0">{user?.last_name}</p>
                                    </div>
                                    <div className="col-sm-4 my-3">
                                        <label htmlFor="" className="semi-bold">Subscription Status</label>
                                        <p className="l-grey-text mb-0">{user?.subscriptionType || "Inactive"} <Link to={"/subscription-plans"}>(View Subscriptions)</Link></p>
                                    </div>
                                    {/* <div className="col-sm-4 my-3">
                                ...
                                <div className="d-flex align-items-center mt-4 gap-3 flex-wrap">
                                    ...
                                    <SiteButton className="orange-btn" onClick={() => navigate(`/change-password`)}>Change Password</SiteButton>
                                </div>
                            </div>
                        </div>
                    </div>
