  ...
  return (
    <BrowserRouter basename='/'>
      ...
      <Routes>
        ...
        <Route path="/reset-password" element={<ProtectedRoute><ForgetPassword /></ProtectedRoute>} />
        <Route path="/register" element={<ProtectedRoute><Register /></ProtectedRoute>} />
        <Route path="/contact-us" element={<ContactUs />} />
        <Route path="/beat-mixed-set" element={<BeatMixedSet />} />
        <Route path="/album-details/:id" element={<AlbumDetails />} />
        <Route path="/subscription-plans" element={<SubscriptionPlansListing />} />
        <Route path="/subscription-plan/:id" element={<SubscriptionPlan />} />
        <Route path="/payment/:id" element={<Payment />} />
        <Route path="/subscription-logs" element={<PrivateRoute><SubscriptionLogs /></PrivateRoute>} />
